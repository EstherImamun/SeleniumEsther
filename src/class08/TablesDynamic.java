...
public class TablesDynamic {
    public static void main(String[] args) {
       ...
       // driver.get("http://secure.smartbearsoftware.com/samples/TestComplete11/WebO" + "rders/login.aspx?ReturnUrl=%2fsample%2fTestComplete11%2fWebOrders%2fDefault.aspx");
